...
function UserProfile() {
  return (
    <div className="bg-gray-100 sm:p-4 md:p-8 max-w-xs sm:max-w-sm my-20 mx-auto rounded-lg shadow-lg text-center">
      <img src={user} alt="User" className='rounded-full w-24 h-24 sm:w-36 sm:h-36 mx-auto object-cover'/>
